...
for filmdiv in filmdivs_list:
    newfilm = {'name': filmdiv.div.a.attrs['title'],
                'href': filmdiv.div.a.attrs['href']}
    newfilms.append(newfilm)
    # qualitylist = 
    print ('\nnext: ', filmdiv.div.findNext('div').find_all('a'))
    # print("next q: ", filmdiv.div.findNext('div'))
'''    print({'name': filmdiv.div.a.attrs['title'],
           'href': filmdiv.div.a.attrs['href']})'''
